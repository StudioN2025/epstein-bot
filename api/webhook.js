  ...
  if (req.method === 'POST') {
    try {
      ...
      // ========== ИВЕНТ СВО ==========
        ...
        let targetUser = data.users[targetId] || { balance: 0, basements: 0, children: 0, mobilized: 0, username: targetName };
        ...
        await sendMessage(BOT_TOKEN, chatId,
          ...
          `🏚️ Захваченных подвалов: ${user.capturedBasements || 0} (дают доход ${capturedIncome} 🧼/час)\n` +
          `📊 Баланс: ${user.balance} 🧼\n\n` +
