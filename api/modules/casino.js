...
export async function handleCasinoCommand(cleanText, rawText, user, data, BOT_TOKEN, chatId, username, userId) {
  ...
  if (isNaN(userNumber) || userNumber < 1 || userNumber > 5) {
    await sendMessage(BOT_TOKEN, chatId, `❌ Число от 1 до 5!`);
    return true;
  }
  if (user.balance < bet) {
